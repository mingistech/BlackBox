...
BlackBox is a native macOS terminal app with an AI assistant for local command-line and remote SSH tasks, supporting OpenAI, Anthropic, and OpenRouter with configurable command approvals.
